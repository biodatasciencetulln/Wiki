...
- Apt update/upgrade before executing tasksel command (`tasksel install ubuntu-desktop`), otherwise it didn't work
- [tasksel description](https://wiki.debian.org/tasksel)
- GNOME (`ubuntu-desktop`) is very fast and responsive, but still ugly; consider something else instead ([computingforgeeks.com](https://computingforgeeks.com/how-to-install-cinnamon-desktop-environment-on-debian/))
- Resolution: in case of problems, try 1440 x 900 ([arstechnica.com](https://arstechnica.com/civis/viewtopic.php?f=19&t=1473419))
